...
CTPS.cmpArtApp.getData = function(){ 
	...
	var szUrl = CTPS.cmpArtApp.szWFSserverRoot + '?';
		...
		szUrl += '&typename=postgis:ctps_cmp_2014_art_routes_ext';
...
CTPS.cmpArtApp.initDetailMap = function() {
	...
	var oSpeedData = new ol.layer.Tile({	
		source: new ol.source.TileWMS({
			url		: CTPS.cmpArtApp.szWMSserverRoot,
			params	: {
				'LAYERS': 'postgis:ctps_cmp_2014_art_routes_ext',
				'STYLES': 'line',
				'TRANSPARENT': 'true'
			}
		}),
...
CTPS.cmpArtApp.initOverviewMap = function() {
	...
	// CTPS.cmpArtApp.szWMSserverRoot2 = 'http://appsrvr2.ctps.org:6080/arcgis/services/Arterial_Overview_Layers_Ext/MapServer/WMSServer'; 
	// CTPS.cmpArtApp.szWMSserverRoot2 = 'http://ctps.org/map/ags/Arterial_Overview_Layers_Ext/MapServer/WMSServer'; 
	// CTPS.cmpArtApp.szWMSserverRoot2 = 'http://lindalino2.ad.ctps.org:6080/arcgis/services/Arterial_Overview_Layers_Ext/MapServer/WMSServer'; 
...
CTPS.cmpArtApp.initDownloadText = function() {
	...
	szTemp += "&typename=postgis:ctps_cmp_2014_art_routes_ext";
	...
	szTemp += "am_cong_sp,am_avg_sp,am_spd_ix,am_avtt_ix,am_del_mi,am_cong_mn,";
	szTemp += "pm_cong_sp,pm_avg_sp,pm_spd_ix,pm_avtt_ix,pm_del_mi,pm_cong_mn";
